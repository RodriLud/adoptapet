...
public class SolicitudController {
	...
	public ResponseEntity<?> registrarFormulario(@RequestParam("id_adoptante") Integer idAdoptante,
			@RequestParam("id_mascota") Integer idMascota,
			@RequestParam(value = "comentario", required = false) String comentario,
			@RequestParam(value = "motivo_adopcion", required = false) String motivoAdopcion,
			@RequestParam(value = "tipo_vivienda", required = false) String tipoVivienda,
			@RequestParam(value = "experiencia_mascotas", required = false) String experienciaMascotas,
			@RequestParam(value = "otras_mascotas", required = false) String otrasMascotas,
			@RequestParam(value = "cantidad_personas_hogar", required = false) Integer cantidadPersonasHogar,
			@RequestParam(value = "comentarios_adicionales", required = false) String comentariosAdicionales,
