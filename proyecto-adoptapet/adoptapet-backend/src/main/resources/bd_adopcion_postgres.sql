-- =========================================================================
-- ADOPTAPET - Script PostgreSQL (para Render)
-- =========================================================================
...
CREATE TABLE solicitud (
    ...
    fecha_cierre_contingencia TIMESTAMP,
...
CREATE TABLE programacion_entrega (
    ...
    hora_inicio         TIME         NOT NULL,
    hora_fin            TIME         NOT NULL,
    fecha_limite_recojo TIMESTAMP    NOT NULL,
...
-- =========================================================================
-- DATOS DE PRUEBA (password = 123 en BCrypt)
-- =========================================================================
TRUNCATE TABLE programacion_entrega, cupo_entrega, solicitud, mascota, adoptante, trabajador, usuario RESTART IDENTITY CASCADE;
...
-- Resetear secuencias para que el próximo INSERT use el id correcto
...
SELECT setval('solicitud_id_solicitud_seq',          (SELECT MAX(id_solicitud)      FROM solicitud));
SELECT setval('cupo_entrega_id_cupo_seq',            (SELECT MAX(id_cupo)           FROM cupo_entrega));
SELECT setval('programacion_entrega_id_programacion_seq', (SELECT MAX(id_programacion) FROM programacion_entrega));
